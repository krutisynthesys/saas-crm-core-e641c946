...
export function TopBar() {
  ...
  return (
    <>
        ...
        <div className="flex items-center gap-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48 bg-popover">
              <DropdownMenuItem className="cursor-pointer" onClick={() => setLeadDialogOpen(true)}>
                New Lead
              </DropdownMenuItem>
              <DropdownMenuItem className="cursor-pointer" onClick={() => setOppDialogOpen(true)}>
                New Opportunity
              </DropdownMenuItem>
              <DropdownMenuItem className="cursor-pointer" onClick={() => setTaskDialogOpen(true)}>
                New Task
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem className="cursor-pointer" onClick={() => setActivityDialogOpen(true)}>
                Log Activity
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
      ...
      <OpportunityFormDialog open={oppDialogOpen} onOpenChange={setOppDialogOpen} />
      <TaskFormDialog open={taskDialogOpen} onOpenChange={setTaskDialogOpen} />
      <ActivityFormDialog open={activityDialogOpen} onOpenChange={setActivityDialogOpen} />
    </>
  );
}
